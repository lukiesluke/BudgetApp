...
public class DailyAnalActivity extends BaseAnalytic {
    ...
    private TextView analtrans, analfood, analhouse, analent, analedu, analcha, analapp, analheal, analper, analoth, monthspent, totalbudget;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalbudget = findViewById(R.id.totalamountspenton);
...
//        entries.add(new PieEntry(((float) budget.getTotalOther()), "Others", null));
        ...
        PieDataSet dataSet = new PieDataSet(entries, "Daily Analytic Results");
    ...
    private void todayExpenses() {
        Log.d("lwg", "calendarDate: " + calendarDate);
        Query query = expensesReference.orderByChild("date").equalTo(calendarDate);
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    totalbudget.setText("Total today Spending: P" + strTotal);
        ...
        personalTotalExpenses.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(DailyAnalActivity.this, "SetStatusAndImageResource Error", Toast.LENGTH_SHORT).show();
                }
            }
