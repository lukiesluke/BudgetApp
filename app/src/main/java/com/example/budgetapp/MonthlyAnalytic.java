...
public class MonthlyAnalytic extends BaseAnalytic {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monthy_anal);
        ...
        appBarTitle.setText("Monthly Analytics");
    ...
    private void pieChart(ArrayList<PieEntry> entries) {
        ...
        chart.setCenterText(generateCenterSpannableTextMonthly());
...
//        entries.add(new PieEntry(((float) budget.getTotalOther()), "Others", null));
        ...
        PieDataSet dataSet = new PieDataSet(entries, "Monthly Analytic Results");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    totalweekamount.setText("Total Month's Spending: P" + strTotal);
        ...
        personalTotalExpenses.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(MonthlyAnalytic.this, "SetStatusAndImageResource Error", Toast.LENGTH_SHORT).show();
                }
            }
